    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-white">
      <div className="w-full max-w-md p-8 bg-gray-50 rounded-xl shadow flex flex-col items-center">
        ...
        <form className="w-full flex flex-col gap-4">
          ...
          <button type="submit" className="bg-black text-white rounded px-4 py-2 font-semibold">Sign Up</button>
        </form>
        ...
        <p className="mt-4 text-sm text-gray-500">Already have an account? <Link href="/auth/login" className="underline">Log in</Link></p>
      </div>
    </main>
  );
}
